...
\begin{figure}[H]
	\centering
	\includegraphics[width=5cm, height=4cm]{./Figures/superlightingLED.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=5cm, height=5cm]{./Figures/superlightingLED2.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=5cm, height=5cm]{./Figures/GIDEALED.png}
