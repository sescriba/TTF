...
\begin{titlepage}
    ...
    \begin{flushright}
        ...
        Sistema inteligente de iluminación de escaleras para el hogar} \\[1.5cm]

        % Autor
        {\fontfamily{phv}\fontsize{20pt}{25pt}\selectfont
        Ing. Pedro Santiago Escribá} \\[1cm]
        ...
        \textbf{Director:} Esp. Ing. Matías Nicolás Brignone (FIUBA)} \\[1cm]

        % Jurados
        {\fontfamily{phv}\fontsize{11pt}{15pt}\selectfont
        \textbf{Jurados:}} \\[0.5cm]
        {\fontfamily{phv}\fontsize{11pt}{15pt}\selectfont
        Esp. Ing. Martín Duarte (UNNE / FIUBA)} \\ 
        {\fontfamily{phv}\fontsize{11pt}{15pt}\selectfont
        Esp. Ing. Santiago Bualo (ITBA / FIUBA)} \\ 
        {\fontfamily{phv}\fontsize{11pt}{15pt}\selectfont
        Esp. Ing. Lucas Fabricio Monzón Languasco (UNNE / FIUBA)} \\[2cm]

        % Fecha y lugar
        {\fontfamily{phv}\itshape\fontsize{10pt}{12pt}\selectfont
        Ciudad de Córdoba, abril de 2026} % Ejemplo: Ciudad de Córdoba, junio de 2025
    \end{flushright}
\end{titlepage}
